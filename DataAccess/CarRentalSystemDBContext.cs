...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server =(local); database = CarRentalSystemDB;uid=sa;pwd=1234567890;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CarProducer>(entity =>
            {
                entity.HasKey(e => e.ProducerId)
                    .HasName("PK__CarProdu__133696B2FE2FA245");
            ...
            modelBuilder.Entity<CarRental>(entity =>
            {
                entity.HasKey(e => new { e.CustomerId, e.CarId, e.PickupDate, e.ReturnDate })
                    .HasName("PK__CarRenta__E01D1225018D989F");
            ...
            modelBuilder.Entity<Review>(entity =>
            {
                entity.HasKey(e => new { e.CustomerId, e.CarId })
                    .HasName("PK__Review__522467F82CD748AF");
            ...
            modelBuilder.Entity<StaffAccount>(entity =>
            {
                entity.HasKey(e => e.StaffId)
                    .HasName("PK__StaffAcc__96D4AAF70AAC7EA4");
